...
var kcRotateDial = function(elem) {
    ...
    if(elem.attachEvent) {
        ...
        document.attachEvent('onmousemove', function() { if(drag) rotate(0); });
        
    }else if(elem.addEventListener) {
        
        elem.addEventListener('mousedown', function(e) { setDrag(e, true); });
        elem.addEventListener('mouseleave', function(e) { setDrag(e, false); });
	
        document.addEventListener('mouseup', function(e) { setDrag(e, false); });
        document.addEventListener('mousemove', function(e) { if(drag) rotate(e); });
